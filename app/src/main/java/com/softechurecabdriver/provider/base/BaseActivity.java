...
import com.softechurecabdriver.provider.ui.activity.password.PasswordActivity;
...
public abstract class BaseActivity extends AppCompatActivity implements MvpView {
    ...
    private Lottiedialogfragment progressDialog;
    ...
    public String getNameResult(Name value){
        ...
        String language=  SharedHelper.getKey(getApplicationContext(),"lang_code","English");
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
       ...
       // progressDialog = new ProgressDialog(this,R.style.AlertDialogCustom);
        progressDialog = new Lottiedialogfragment(this);
