...
public class UserResponse {
    ...
    @Expose
    private String referral_details;
    ...
    @Expose
    private ArrayList<ReferralsData> referrals;
    ...
    public ArrayList<ReferralsData> getReferrals() {
        return referrals;
    }

    public void setReferrals(ArrayList<ReferralsData> referrals) {
    ...
    public String getReferral_details() {
        return referral_details;
    }

    public void setReferral_details(String referral_details) {
        this.referral_details = referral_details;
    }
    ...
    public void setRide_toll(String ride_toll) {
        this.ride_toll = ride_toll;
    }
