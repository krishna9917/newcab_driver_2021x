    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.imgMail:
                ...
                break;
            case R.id.imgWeb:
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(help.getContactLink()));
        ...
        if (!allPermissionsGranted) {
            ...
            if (somePermissionsForeverDenied) {
                ...
                alertDialogBuilder.setTitle("Permissões necessárias")
                        .setMessage("Você negou algumas das permissões necessárias para este provider " +
                                "Por favor, abra as configurações, procure pelo provider vá para permissões e permita-as.")
    ...
    private class PhoneCallListener extends PhoneStateListener {
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            if (TelephonyManager.CALL_STATE_IDLE == state) {
                ...
                Log.i(LOG_TAG, "IDLE");
                if (isPhoneCalling) {
                    Log.i(LOG_TAG, "restart provider");
