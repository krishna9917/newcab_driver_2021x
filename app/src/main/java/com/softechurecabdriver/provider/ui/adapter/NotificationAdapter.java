...
public class NotificationAdapter extends RecyclerView.Adapter<NotificationAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Glide.with(mContext)
                .load(BuildConfig.BASE_IMAGE_URL+notifications.get(position).getImage())
                .apply(RequestOptions.placeholderOf(R.drawable.ic_notification)
                        .dontAnimate().error(R.drawable.ic_notification))
