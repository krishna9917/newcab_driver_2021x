...
import com.softechurecabdriver.provider.common.RecyclerItemClickListener;
...
import com.softechurecabdriver.provider.ui.adapter.PlacesAutoCompleteAdapter;
...
public class InstantRideActivity extends BaseActivity
    ...
    private static final LatLngBounds BOUNDS_INDIA = new LatLngBounds(new LatLng(11.586677, 43.147869), new LatLng(11.586677, 43.147869));
...
//        }
    ...
    public void onSuccess(EstimateFare estimateFare) {
        hideLoading();
        instantRide.put("estimated_fare", estimateFare.getEstimatedFare());
