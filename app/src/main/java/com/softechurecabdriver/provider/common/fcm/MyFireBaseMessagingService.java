package com.softechurecabdriver.provider.common.fcm;
...
public class MyFireBaseMessagingService extends FirebaseMessagingService {
    ...
    public void createNotification(String message, Boolean isChat){
        ...
        PendingIntent resultPendingIntent = PendingIntent.getActivity(this, 0 /* Request code */, intent, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        ...
        PendingIntent acceptPendingIntent = PendingIntent.getBroadcast(this, 0, accept, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
        ...
        PendingIntent rejectPendingIntent = PendingIntent.getBroadcast(this, 0, reject, PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_IMMUTABLE);
