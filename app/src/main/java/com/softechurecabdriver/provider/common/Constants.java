...
public class Constants {
    public static final String BASE_URL_NEW = "https://www.website4test.com/softechurecab/public/";
    ...
    public static ArrayList<ReferralsData> referrals=new ArrayList<>();
    ...
    public interface ReferalKey {
        ...
        String REFERRAL_INVITE_TEXT="REFERRAL_INVITE_TEXT";
    }
