package com.softechurecabdriver.provider.common;
...
import com.softechurecabdriver.provider.ui.activity.welcome.WelcomeActivityNew;
...
public class Utilities {
    ...
    public static void LogoutApp(Activity thisActivity, String logout_text) {
        ...
        logout_text = "Logout Successfully";
        ...
        Intent inin  =new  Intent(thisActivity,ChatHeadService.class);
        thisActivity.stopService(inin);
        Intent serviceIntent = new Intent(thisActivity, GPSTracker.class);
        thisActivity.stopService(serviceIntent);

        Intent goToLogin = new Intent(thisActivity, WelcomeActivityNew.class);
...
//        Toasty.success(thisActivity, thisActivity.getString(R.string.logout_successfully), Toast.LENGTH_SHORT).show();
        ...
        Intent serviceIntent = new Intent(thisActivity, GPSTracker.class);
        thisActivity.stopService(serviceIntent);
        thisActivity.startActivity(new Intent(thisActivity, WelcomeActivityNew.class));
        thisActivity.finishAffinity();
    }
    ...
    public static void startPowerSaverIntent(Context context) {
        ...
        // Verifica se dispositivo precisa de aviso
        if (!"huawei".equalsIgnoreCase(Build.BRAND.toLowerCase()) ||
                ...
                !"nokia".equalsIgnoreCase(Build.BRAND.toLowerCase())) return;

        // Verifica aviso ainda deve ser exibido ao usuario
        ...
        if (!skipMessage) {
            ...
            // Exibe alerta pedindo usuario para ir na tela de configuracoes
            new AlertDialog.Builder(context,R.style.AlertDialogCustom)
                    .setTitle(Build.MANUFACTURER + context.getString(R.string.protected_apps))
                    .setMessage(String.format("%s " + context.getString(R.string.app_protection_activation_needed) + "%n", context.getString(R.string.app_name)))
                    .setView(dontShowAgain)
                    .setPositiveButton(R.string.go_to_settings, (dialog, which) -> AutoStartPermissionHelper.getInstance().getAutoStartPermission(context))
