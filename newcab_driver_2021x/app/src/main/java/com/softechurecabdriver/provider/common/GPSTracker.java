    ...
    private android.location.LocationListener mLocationListener = new android.location.LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            if (location.getProvider().equals(KalmanLocationManager.KALMAN_PROVIDER)) {
                ...
                if (DATUM != null && DATUM.getStatus().equalsIgnoreCase("ACCEPTED")
                        || DATUM != null && DATUM.getStatus().equalsIgnoreCase("STARTED")
                        || DATUM != null && DATUM.getStatus().equalsIgnoreCase("ARRIVED")
                        || DATUM != null && DATUM.getStatus().equalsIgnoreCase("PICKEDUP")) {
